...
"Float() function allows you to turn an integer into a decimal. Input() function allows you to type data into a program and assign it to a variable. " "The lens() function returns the length of an object."
# 2. What data type will the following snippet of code output?
print(30/ 232)
"The code will output float"
...
# ==
# >
"And belongs to the logical operator family. == belongs to the comparison family. > belongs to the comparison family."
# 4. Explain the difference between the = operator and the == operator.
# Please write your response in complete sentences.
"The == operator compares if the values are the same."
...
# Please write your response in complete sentences.
"A parameter is a placeholder." "An argument is the actual value of a function."
# 7. What is the difference between a function definition 
# and a function invocation? # Please write your response in 
# complete sentences.
"A function definition describes what the function is." "A function invocation calls the function."
# 8. Why are functions useful in programming? Provide at least two reasons 
# and write your reasons in in complete sentences.
"Functions are useful because they tell computers what to do." "Functions are what give programming the power it has and help computers learn." "Functions give us code and allow us to pass data between programs."
